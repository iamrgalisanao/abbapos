import syncEngine from '../src/engines/SyncEngine.js';
import persistenceManager from '../src/engines/PersistenceManager.js';
...
async function verifyOfflineSync() {
  ...
  const newInstance = (await import('../src/engines/SyncEngine.js?update=' + Date.now())).default;
